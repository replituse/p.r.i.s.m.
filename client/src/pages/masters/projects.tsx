...
export default function ProjectsPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: ProjectFormData & { id: number }) =>
      apiRequest("PUT", `/api/projects/${data.id}`, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/projects"] });
      setShowModal(false);
    ...
    <AppLayout>
      <div className="p-6" data-testid="projects-page">
        ...
        <Dialog open={showModal} onOpenChange={setShowModal}>
          <DialogContent data-testid="project-form-modal">
            <DialogHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea {...field} placeholder="Project description" rows={3} data-testid="textarea-project-description" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    <FormItem className="flex items-center gap-2">
                      <FormControl>
                        <Checkbox
                          ...
                          data-testid="checkbox-project-active"
                        />
                      </FormControl>
